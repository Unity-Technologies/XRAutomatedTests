...
namespace HoloToolkit.Unity
{
    ...
    public class BuildDeployWindow : EditorWindow
    {
        ...
        public static bool AppxInstallSucces = false;
        ...
        public static void InstallOnTargetDevice(string buildPath, ConnectInfo targetDevice)
        {
            isAppRunning = false;
            ...
            if (BuildDeployPortal.InstallApp(files[0].FullName, targetDevice))
            {
                AppxInstallSucces = true;
            }
        }
