...
namespace Tests
{
    public class XrApiCheck : DayDreamTestBase
    {
        [Test]
        public void MobilePlatformCheck()
        {
            ...
            {
                Assert.IsTrue(Application.isMobilePlatform, "daydream returned as a non mobile platform ");
            }
            else
            {
                Assert.IsFalse(Application.isMobilePlatform, "Standalone returned as a mobile platform");
            }
        }
        ...
        {
            Assert.AreEqual("daydream", XRSettings.loadedDeviceName, "Wrong XR Device reported");
        }
