...
public class EyeCameraCheck : TestBaseSetup
{
    ...
    {
        m_CameraTransform = m_TestSetupHelpers.m_Camera.transform;
    ...
    {
        Matrix4x4 left = m_TestSetupHelpers.m_Camera.GetComponent<Camera>().GetStereoViewMatrix(Camera.StereoscopicEye.Left);
        Matrix4x4 right = m_TestSetupHelpers.m_Camera.GetComponent<Camera>().GetStereoViewMatrix(Camera.StereoscopicEye.Right);
        ...
        Vector3 rightDir = m_TestSetupHelpers.m_Camera.transform.right;
    ...
    public void EyePositionCheck()
    {
        ...
        Vector3 LeftEyeInverse = m_TestSetupHelpers.m_Camera.transform.InverseTransformVector(LeftEye);
        Vector3 RightEyeInverse = m_TestSetupHelpers.m_Camera.transform.InverseTransformVector(RightEye);
