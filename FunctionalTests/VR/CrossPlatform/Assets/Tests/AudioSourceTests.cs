...
public class AudioSourceTests : XrFunctionalTestBase
{
    ...
    public override void SetUp()
    {
        ...
        XrFunctionalTestHelpers.Cube.AddComponent<AudioSource>();
        XrFunctionalTestHelpers.Cube.GetComponent<AudioSource>().clip = Resources.Load("Audio/FOA_speech_ambiX", typeof(AudioClip)) as AudioClip;

        audioSource = XrFunctionalTestHelpers.Cube.GetComponent<AudioSource>();
        XrFunctionalTestHelpers.Camera.AddComponent<AudioListener>();
    }
