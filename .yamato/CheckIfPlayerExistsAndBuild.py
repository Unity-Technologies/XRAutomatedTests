...
#Combine these 3 hashes to generate a filename that is unique to this unity version, autoamtedtests version, and test parameters.
...
if(PlayerExists is False):
    ...
    zipdir(outputFolderToArchive, zipf)
    zipf.close()
...
if os.getenv("runTests") == "True":
    ...
    #Sleep for 30 seconds. This is due to the fact that Jenkins will occassionally take a little time to collect the
    #build artifacts after a job is done.
    time.sleep(30)
